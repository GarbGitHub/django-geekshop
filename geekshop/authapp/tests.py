...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = ShopUser.objects.create_superuser('django2', 'django2@geekshop.local', 'Geekbra4ins')

        self.user = ShopUser.objects.create_user('tarantino', 'tarantino@geekshop.local', 'Geekbra4ins')
    ...
    def test_user_login(self):
        ...
        # данные пользователя
        self.client.login(username='tarantino', password='Geekbra4ins')
